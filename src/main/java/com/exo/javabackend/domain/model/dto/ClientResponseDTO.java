...
public record ClientResponseDTO(
    ...
    public ClientResponseDTO(String reference, String civilite, String nom, String prenom, Map<TypeEnergie,
    ...
    public ClientResponseDTO(String reference, String numSiret, String raisonSociale,
